            ...
            <div className="bg-white rounded-lg p-6 mb-8 border">
              ...
              <div className="text-left space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-700">Toolkit access credentials</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Gift className="w-4 h-4 text-green-500" />
                  <span className="text-gray-700">Notion resource hub invitation</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Gift className="w-4 h-4 text-green-500" />
                  <span className="text-gray-700">Slack community invitation</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Gift className="w-4 h-4 text-green-500" />
